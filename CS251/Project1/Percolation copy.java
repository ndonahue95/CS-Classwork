...
public class PercolationQuick {
    ...
    public void open(int x, int y) {
        ...
        if ( isOutOfBounds(x, y) ) {
            ...
            if (x == datnum - 1) {
                ...
                quf.union(reverseinception(x, y), virtualTop - 1);
            ...
            if (x == 0) {
                ...
                quf.union(reverseinception(x, y), virtualBot - 1);
            ...
            if ( (y + 1) < datnum && isOpen(x, y + 1) ) {
                ...
                quf.union(reverseinception(x, y), reverseinception(x, y+1));
            ...
            if ( (x - 1) >= 0 && isOpen(x - 1, y) ) {
                ...
                quf.union(reverseinception(x, y), reverseinception(x-1, y));
    ...
    public boolean isFull(int x, int y) {
        ...
        if ( isOutOfBounds(x, y) ) {
            ...
            for (int i = 0; i < datnum; i++) {
                ...
                if ( quf.connected(datnum * datnum - 1 - i, reverseinception(x, y)) ) {
                    
                    //System.out.println(quf.count() + "   " + reverseinception(x,y));
    ...
    public boolean percolates() {
        ...
        return quf.connected(virtualTop - 1, virtualBot - 1);
